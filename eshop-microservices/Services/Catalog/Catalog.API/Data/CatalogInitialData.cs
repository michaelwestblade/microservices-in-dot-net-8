...
public class CatalogInitialData: IInitialData
{
    ...
    private static IEnumerable<Product> GetPreconfiguredProducts() => new List<Product>()
    {
        new Product()
        {
            ...
            Price = 950.00M,
            CategoryIds = new List<string> { "Smart Phone" }
        },
        new Product()
        {
        ...
        new Product()
        {
            ...
            Description =
                "This phone is the company's biggest change to its flagship smartphone in years. It includes a borderless.",
            ImageFileName = "product-3.png",
            Price = 650.00M,
            CategoryIds = new List<string> { "White Appliances" }
        },
        new Product()
        {
        ...
        new Product()
        {
            ...
            Description =
                "This phone is the company's biggest change to its flagship smartphone in years. It includes a borderless.",
            ImageFileName = "product-6.png",
            Price = 240.00M,
            CategoryIds = new List<string> { "Home Kitchen" }
        },
        new Product()
        {
            ...
            ImageFileName = "product-6.png",
            Price = 240.00M,
            CategoryIds = new List<string> { "Camera" }
        }
    };
}